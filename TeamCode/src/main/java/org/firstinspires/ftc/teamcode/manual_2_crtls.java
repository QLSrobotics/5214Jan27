...
public class manual_2_crtls extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.a){lDum.setPosition(.15);rDum.setPosition(.85);}
            if(gamepad1.b){lDum.setPosition(1);rDum.setPosition(0);}
            if(gamepad1.x){lDum.setPosition(.45);rDum.setPosition(.45);}
            if(gamepad1.y){lDum.setPosition(0);rDum.setPosition(1);}
