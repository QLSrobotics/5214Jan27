...
@TeleOp(name="5214Manual", group="Team5214")
//@Disabled
public class 5214Manual extends LinearOpMode {
...
public void runOpMode() throws InterruptedException{
        ...
        // color servo test NEED TO EDIT VALUES
        if(gamepad2.x){colSer.setPosition(.9); knckSer.setPosition(.5);}
